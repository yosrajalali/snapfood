    ...
    <div class="fixed flex flex-col top-5 bottom-5 right-5 w-14 hover:w-64 md:w-64 custom-purple text-white transition-all duration-300 border-none z-10 sidebar rounded-lg">
        <div class="overflow-y-auto overflow-x-hidden flex flex-col justify-between flex-grow">
            <ul class="flex flex-col py-4 space-y-1">
                ...
                <li>
                    <a href="{{ route('seller.recentOrders') }}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-purple-700 text-white hover:text-white border-r-4 border-transparent hover:border-purple-400 pr-6 rounded-lg">
                        <span class="inline-flex justify-center items-center mr-4">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span class="mr-2 text-sm tracking-wide truncate">سفارشات جاری</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('seller.archived-orders') }}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-purple-700 text-white hover:text-white border-r-4 border-transparent hover:border-purple-400 pr-6 rounded-lg">
                        <span class="inline-flex justify-center items-center mr-4">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <li>
                    <a href="{{ route('seller.foods.index') }}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-purple-700 text-white hover:text-white border-r-4 border-transparent hover:border-purple-400 pr-6 rounded-lg">
                        <span class="inline-flex justify-center items-center mr-4">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <li>
                    <a href="{{ route('seller.reports.index') }}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-purple-700 text-white hover:text-white border-r-4 border-transparent hover:border-purple-400 pr-6 rounded-lg">
                        <span class="inline-flex justify-center items-center mr-4">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <li>
                    <a href="{{ route('seller.comments.index') }}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-purple-700 text-white hover:text-white border-r-4 border-transparent hover:border-purple-400 pr-6 rounded-lg">
                        <span class="inline-flex justify-center items-center mr-4">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <li>
                    <a href="{{route('seller.restaurants.create')}}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-purple-700 text-white hover:text-white border-r-4 border-transparent hover:border-purple-400 pr-6 rounded-lg">
                        <span class="inline-flex justify-center items-center mr-4">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v16M20 4v16M4 4h16M4 20h16M9 9h6M9 12h6M9 15h6"></path>
                            </svg>
                        </span>
                        <span class="mr-2 text-sm tracking-wide truncate">ثبت رستوران</span>
                    </a>
                </li>
                <li>
                    <a href="{{route('seller.restaurant.settings.edit')}}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-purple-700 text-white hover:text-white border-r-4 border-transparent hover:border-purple-400 pr-6 rounded-lg">
                        <span class="inline-flex justify-center items-center mr-4">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
