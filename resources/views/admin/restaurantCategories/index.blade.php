    ...
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center pb-4 space-y-2 md:space-y-0">
            ...
            <div class="flex flex-col md:flex-row items-center w-full md:w-auto space-y-2 md:space-y-0 md:space-x-2">
                <form action="{{ route('admin.restaurantCategories.index') }}" method="GET" class="w-full md:w-auto flex-grow md:flex-grow-0">
                ...
                <a href="{{ route('admin.restaurantCategories.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded transition duration-300 ease-in-out w-full md:w-auto text-xs md:text-sm">
                    افزودن دسته‌بندی
                </a>
            </div>
        </div>
